		...
		//		Console.WriteLine (antwort);
			...
			//	Console.WriteLine (antwort);
				...
				if (spieler.IstEsDrinn ("crowbar")) {
					...
					Console.WriteLine ("You try to open the trap door but it's blocked. \n You need a device to help you open it.");
				}
